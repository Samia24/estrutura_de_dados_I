...
void atualizarAlunos(Aluno *alunos, int qtdAlunos);
void buscarAlunosPorMatricula(Aluno *alunos, int qtdAlunos);
void buscarAlunosPorNome(Aluno *alunos, int qtdAlunos);
